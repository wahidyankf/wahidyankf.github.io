...
},{"process":"../../../../.config/yarn/global/node_modules/process/browser.js"}],"js/data.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var dataCV = exports.dataCV = {
  personalData: {
  ...
  skills: {
    ...
    toolsAndLibraries: ['React', 'React Native', 'Redux', 'Rematch', 'Redux-Saga', 'Redux Form', 'flow-typed', 'TypeScript', 'CSS in JS', 'Sass', 'jQuery', 'Git', 'npm/yarn', 'gulp.js', 'webpack', 'Mocha', 'Chai', 'Moment.js', 'vim', 'TMUX', 'LaTeX'],
    pastExperience: ['Assembly (AT Mega 8051)', 'PHP', 'MySQL', 'Matlab', 'C++']
  },
  formalEducation: [{
  ...
  portfolio: [{
    ...
    description: 'In this project, an HTML and CSS files was given and I have to add interactivity to the existing form there. The resulting page is an interactive HTML form that has a simple form validity checker.',
    ...
    description: 'In this project, an HTML page and CSS files was given and I have to add a search and pagination feature using unobstrusive javascript. The resulting page is a page that display at most 10 student entries with an instant student search capabilities.',
    ...
    description: 'In this project, I created a page that will randomly generate quotes from a data object. This page will change its displayed quote when we click the button / pres any key / 30 seconds has passed. This page will also not displayed the same quote until all of quotes has been displayed.',
    skillSetUsed: ['HTML', 'CSS', 'Sass', 'JavaScript', 'jQuery'],
    start: '08/2017',
    end: '08/2017',
  ...
  courses: {
    engineeringCourse: [{
      ...
      type: 'online',
      description: 'This course taught about webpack build tool. The topics included in this course are the fundamentals of webpack, project assets handling, webpack on real project, webpack dev server, webpack-based deployment for static sites, and webpack-based deployment for dynamic sites.',
      start: '08/2017',
      end: '08/2017'
    }, {
      ...
      type: 'online',
      description: 'This compilation of courses taught the combination of HTML, CSS and JavaScript on which all modern websites are built. This track also taught us about responsive web design, intro to bootstrap 4, website optimization, git, accessibility, and foundation of console/command line.',
      start: '05/2017',
      end: '05/2017'
    }, {
      ...
      type: 'online',
      description: 'This compilation of courses taught about how to design and build websites by learning the basic principles of design. This track also taught HTML, CSS and Sass.',
      start: '03/2017',
      end: '03/2017'
    }, {
      ...
      type: 'online',
      description: 'This course taught about how to write functions in Python, including functions with multiple parameters, functions with multiple return value, and lambda functions. This course also taught about ways to handle errors in Python.',
      start: '03/2017',
      end: '03/2017'
    }, {
...
},{}],"js/libs/datetime.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
var formatTimeDuration = exports.formatTimeDuration = function formatTimeDuration(timeDuration) {
  ...
  var formattedTimeDuration = void 0;
...
var dateShown = exports.dateShown = function dateShown(start, end) {
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'compact';

  var dateNow = new Date();
  var startMonth = '' + Number(start.slice(0, 2) - 1);
  var startYear = '' + Number(start.slice(3));

  var endMonth = end.toLowerCase() === 'now' ? '' + dateNow.getMonth() : '' + Number(end.slice(0, 2) - 1);
  ...
  var timeDuration = dateEnd - dateStart;

  var duration = type === 'compact' ? '' : '<i class="fa fa-circle time-duration"></i>' + formatTimeDuration(timeDuration);
...
},{}],"js/cvbuilder.js":[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.organizationalExperienceContent = exports.additionalActivitiesContent = exports.educationContent = exports.portfolioContent = exports.workExperienceContent = exports.skillsContent = exports.summaryContent = exports.headerContent = undefined;

var _data = require('./data');

var _datetime = require('./libs/datetime');

// ----- header

var headerContent = exports.headerContent = '\n<div class="title">\n  <h1 class="name">' + _data.dataCV.personalData.name + '</h1>\n  <span class="name-job">' + _data.dataCV.personalData.shortDesc + '</span>\n</div>\n<div class="contact">\n  <span class=contact-detail><i class="fa fa-github"></i> <a href="' + _data.dataCV.personalData.socialHub.github + '">wahidyankf</a></span> \n  <span class=contact-detail><i class="fa fa-linkedin"></i> <a href="' + _data.dataCV.personalData.socialHub.linkedin + '">wahidyankf</a></span>\n  <span class=contact-detail><i class="fa fa-envelope"></i> <a href="mailto:' + _data.dataCV.personalData.email + '">wahidyankf@gmail.com</a></span>\n  <span class=contact-detail><i class="fa fa-map-marker"></i> ' + _data.dataCV.personalData.address + '</span>\n</div>\n';

// ----- summary

var summaryContent = exports.summaryContent = '\n<section class="portfolio-section summary">\n  <h2>Summary</h2>\n  <p>' + _data.dataCV.personalData.summary + '</p>\n</section>\n';

// ----- skills

var skillsProgLangContent = _data.dataCV.skills.programmingLanguage.reduce(function (acccumulator, currentValue) {
  return acccumulator + '<p>' + currentValue.level + ': ' + currentValue.languages.join(', ') + '.</p>';
}, '');

var skillsToolsContent = _data.dataCV.skills.toolsAndLibraries.reduce(function (acccumulator, currentSkill, index) {
  return '' + acccumulator + currentSkill + (index === _data.dataCV.skills.toolsAndLibraries.length - 1 ? '.' : ', ');
}, '');

var skillsLanguageContent = _data.dataCV.skills.language.reduce(function (acccumulator, currentLanguage, index) {
...
for (var i = 0; i < _data.dataCV.skills.pastExperience.length; i++) {
  skillsPastContent += '' + _data.dataCV.skills.pastExperience[i];
  if (i < _data.dataCV.skills.pastExperience.length - 1) {
    skillsPastContent += ', ';
  } else {
    skillsPastContent += '.';
  }
...
for (var _i2 = 0; _i2 < _data.dataCV.portfolio.length; _i2++) {
  var stackUsed = '';
  for (var j = 0; j < _data.dataCV.portfolio[_i2].skillSetUsed.length; j++) {
    stackUsed += '' + _data.dataCV.portfolio[_i2].skillSetUsed[j];
    if (j < _data.dataCV.portfolio[_i2].skillSetUsed.length - 1) {
      stackUsed += ', ';
    } else {
      stackUsed += '.';
    }
  }
  portfolioItemContent += '\n  <ul>\n    <li><span class="list-title"><a href="' + _data.dataCV.portfolio[_i2].link + '">' + _data.dataCV.portfolio[_i2].name + '</a></span> <span class="list-subtitle"> - ' + (0, _datetime.dateShown)(_data.dataCV.portfolio[_i2].start, _data.dataCV.portfolio[_i2].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.portfolio[_i2].description + ' Stack used: ' + stackUsed + '</li>\n  </ul>\n  ';
}

var portfolioContent = exports.portfolioContent = '\n<section class="portfolio-section">\n  <h2>Personal Projects</h2>\n  <ul>\n    ' + portfolioItemContent + '\n  </ul>\n</section>\n';

var educationItemContent = '';

for (var _i3 = 0; _i3 < _data.dataCV.formalEducation.length; _i3++) {
  educationItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.formalEducation[_i3].type + ' Degree in ' + _data.dataCV.formalEducation[_i3].major + '</span><span class="list-subtitle"> - ' + _data.dataCV.formalEducation[_i3].institution + ' - ' + _data.dataCV.formalEducation[_i3].location + ' - ' + (0, _datetime.dateShown)(_data.dataCV.formalEducation[_i3].start, _data.dataCV.formalEducation[_i3].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.formalEducation[_i3].info + '</li>\n  </ul> \n  ';
}

var educationContent = exports.educationContent = '\n<section class="education">\n  <h2>Formal Education</h2>\n  <ul>\n    ' + educationItemContent + '\n  </ul>\n</section>\n';

// ----- additional activities

var additionalActivitiesItemContent = '';
for (var _i4 = 0; _i4 < _data.dataCV.additionalActivities.length; _i4++) {
  additionalActivitiesItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.additionalActivities[_i4].jobtitle + '</span><span class="list-subtitle"> - ' + _data.dataCV.additionalActivities[_i4].institution + ' - ' + _data.dataCV.additionalActivities[_i4].location + ' - ' + (0, _datetime.dateShown)(_data.dataCV.additionalActivities[_i4].start, _data.dataCV.additionalActivities[_i4].end, 'verbose') + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.additionalActivities[_i4].description + '</li>\n  </ul>\n  ';
}

var additionalActivitiesContent = exports.additionalActivitiesContent = '\n<section class="portfolio-section">\n  <h2>Additional Activities</h2>\n  <ul>\n    ' + additionalActivitiesItemContent + '\n  </ul>\n</section>\n';

// ----- organizational experience

var organizationalExperienceItemContent = '';
for (var _i5 = 0; _i5 < _data.dataCV.organizationalExperience.length; _i5++) {
...
for (var _i6 = 0; _i6 < _data.dataCV.courses.engineeringCourse.length; _i6++) {
  if (_data.dataCV.courses.engineeringCourse[_i6].type === 'online') {
    engineeringCourseItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.courses.engineeringCourse[_i6].name + '</span><span class="list-subtitle"> - ' + _data.dataCV.courses.engineeringCourse[_i6].institution + ' - <a href="' + _data.dataCV.courses.engineeringCourse[_i6].location + '">course link</a> - ' + (0, _datetime.dateShown)(_data.dataCV.courses.engineeringCourse[_i6].start, _data.dataCV.courses.engineeringCourse[_i6].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.courses.engineeringCourse[_i6].description + '</li>\n  </ul>\n  ';
  } else {
    engineeringCourseItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.courses.engineeringCourse[_i6].name + '</span><span class="list-subtitle"> - ' + _data.dataCV.courses.engineeringCourse[_i6].institution + ' - ' + _data.dataCV.courses.engineeringCourse[_i6].location + ' - ' + (0, _datetime.dateShown)(_data.dataCV.courses.engineeringCourse[_i6].start, _data.dataCV.courses.engineeringCourse[_i6].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.courses.engineeringCourse[_i6].description + '</li>\n  </ul>\n  ';
  }
}
...
for (var _i7 = 0; _i7 < _data.dataCV.courses.nonEngineeringCourse.length; _i7++) {
  if (_data.dataCV.courses.nonEngineeringCourse[_i7].type === 'online') {
    nonEngineeringCourseItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.courses.nonEngineeringCourse[_i7].name + '</span><span class="list-subtitle"> - ' + _data.dataCV.courses.nonEngineeringCourse[_i7].institution + ' - <a href="' + _data.dataCV.courses.nonEngineeringCourse[_i7].location + '">course link</a> - ' + (0, _datetime.dateShown)(_data.dataCV.courses.nonEngineeringCourse[_i7].start, _data.dataCV.courses.nonEngineeringCourse[_i7].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.courses.nonEngineeringCourse[_i7].description + '</li>\n  </ul>\n  ';
  } else {
    nonEngineeringCourseItemContent += '\n  <ul>\n    <li><span class="list-title">' + _data.dataCV.courses.nonEngineeringCourse[_i7].name + '</span><span class="list-subtitle"> - ' + _data.dataCV.courses.nonEngineeringCourse[_i7].institution + ' - ' + _data.dataCV.courses.nonEngineeringCourse[_i7].location + ' - ' + (0, _datetime.dateShown)(_data.dataCV.courses.nonEngineeringCourse[_i7].start, _data.dataCV.courses.nonEngineeringCourse[_i7].end) + '</span></li>\n  </ul>\n  <ul class="list-bullet-point">\n    <li>' + _data.dataCV.courses.nonEngineeringCourse[_i7].description + '</li>\n  </ul>\n  ';
  }
}
...
},{"./data":"js/data.js","./libs/datetime":"js/libs/datetime.js"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"css/app.css":[function(require,module,exports) {

var reloadCSS = require('_css_loader');
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./../fonts/fontawesome-webfont.eot":[["fontawesome-webfont.717ca777.eot","fonts/fontawesome-webfont.eot"],"fonts/fontawesome-webfont.eot"],"./../fonts/fontawesome-webfont.woff2":[["fontawesome-webfont.8833b628.woff2","fonts/fontawesome-webfont.woff2"],"fonts/fontawesome-webfont.woff2"],"./../fonts/fontawesome-webfont.woff":[["fontawesome-webfont.f6209b91.woff","fonts/fontawesome-webfont.woff"],"fonts/fontawesome-webfont.woff"],"./../fonts/fontawesome-webfont.ttf":[["fontawesome-webfont.9ee3e1db.ttf","fonts/fontawesome-webfont.ttf"],"fonts/fontawesome-webfont.ttf"],"./../fonts/fontawesome-webfont.svg":[["fontawesome-webfont.57dea505.svg","fonts/fontawesome-webfont.svg"],"fonts/fontawesome-webfont.svg"],"_css_loader":"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/app.js":[function(require,module,exports) {
'use strict';
...
var _cvbuilder = require('./cvbuilder');

require('../css/app.css');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _jquery2.default)('#js-check').hide();

var mainContent = '\n' + _cvbuilder.summaryContent + '\n' + _cvbuilder.workExperienceContent + '\n' + _cvbuilder.skillsContent + '\n' + _cvbuilder.portfolioContent + '\n' + _cvbuilder.educationContent + '\n' + _cvbuilder.additionalActivitiesContent + '\n' + _cvbuilder.organizationalExperienceContent + '\n';
...
//# sourceMappingURL=/app.b18e9a58.map