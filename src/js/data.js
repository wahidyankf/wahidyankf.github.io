  ...
  workExperience: [
    {
      ...
      description: [
        `Developed Ruang Kerja's company dashboard using React JS stacks and flow-typed. Resulting a finely crafted and run-time error free complex dashboard web apps. This apps is still under active development, so its performance metrics information is not yet available (it is subject to change).`,
        `Became one of the pioneering engineers in Ruang Kerja's React Native apps development. Resulting a more efficient engineering resources usage for Ruang Guru by expanding the usages of its front end engineers, while theoretically cut the cost of apps development down almost to 50% without losing any of native apps' development speed.`,
