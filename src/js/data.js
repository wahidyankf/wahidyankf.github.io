  ...
  workExperience: [
    {
      ...
      description: [
        `Rewrite and migrate uji.ruangguru.com from angular.js' stacks to react.js' stacks from scratch. Resulting in unified front-end web's stacks for ruangguru.com and more efficient development process.`,
        ...
        `Refactor ruangguru.com assets and code base using imgIX, AWS S3 bucket, and fastly CDN. Resulting in loads time speed improvement of more than 300% (from more than 12 seconds average to under 3 seconds),  and launch its webpagetest.org score average of B to all A's without sacrificing assets' apparent quality.`
      ],
      start: '10/2017',
      end: 'Now'
    },
