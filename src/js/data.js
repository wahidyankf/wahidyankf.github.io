  ...
  workExperience: [
    {
      ...
      description: [
        `Developed Ruang Kerja's company dashboard using React JS stacks and flow-typed. Resulting in a finely crafted and run-time error free complex dashboard web app. This app is still under active development, so its performance metrics information is not yet available (it is subject to change).`,
