  ...
  workExperience: [
    {
      ...
      description: [
        `Developed Ruang Kerja's company dashboard using React JS stacks, flow-typed, and data visualization tools. Resulting in a finely crafted and runtime-error free complex dashboard web app.`,
