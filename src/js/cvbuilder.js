...
for (let i = 0; i < dataCV.formalEducation.length; i++) {
  ...
  <ul>
    <li><span class="list-title">${dataCV.formalEducation[i].type} Degree in ${dataCV.formalEducation[i]
		.major}</span><span class="list-subtitle"> - ${dataCV.formalEducation[i].institution} - ${dataCV
		.formalEducation[i].location} - ${dateShown(
...
for (let i = 0; i < dataCV.courses.engineeringCourse.length; i++) {
  ...
  <ul>
    <li><span class="list-title">${dataCV.courses.engineeringCourse[i]
		.name}</span><span class="list-subtitle"> - ${dataCV.courses.engineeringCourse[i]
  ...
  <ul>
    <li><span class="list-title">${dataCV.courses.engineeringCourse[i]
		.name}</span><span class="list-subtitle"> - ${dataCV.courses.engineeringCourse[i].institution} - ${dataCV
			.courses.engineeringCourse[i].location} - ${dateShown(
			dataCV.courses.engineeringCourse[i].start,
			dataCV.courses.engineeringCourse[i].end
		)}</span></li>
  </ul>
