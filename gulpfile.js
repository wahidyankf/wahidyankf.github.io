...
gulp.task('copyImage', function() {
	return gulp.src(options.src + '/img/**').pipe(gulp.dest(options.dist + '/img'));
});

gulp.task('copyFonts', function() {
	return gulp.src(options.src + '/fonts/**').pipe(gulp.dest(options.dist + '/fonts'));
});

gulp.task('copyAudio', function() {
	return gulp.src(options.src + '/audio/**').pipe(gulp.dest(options.dist + '/audio'));
});

gulp.task('copyVideo', function() {
	return gulp.src(options.src + '/video/**').pipe(gulp.dest(options.dist + '/video'));
});
